        ...
        <Card 
            cardHeader = {(
                <CardHeader>
                    ...
                    <img className="w-24 h-24 translate-y-1/3 object-cover rounded-full shadow-2xl bg-white" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${data.code}.png`} alt="" />
                    </div>
                </CardHeader>
                )}
                cardBody = {(
                <CardBody>
                    ...
                    <div>
                        <h2 className="text-center py-4 text-2xl font-bold justify-center">{data.name}</h2>
                    </div>
                    <div className="flex rounded-xl bg-teal-100 px-2 py-4 justify-center">
                ...
                <CardFooter>
                    ...
                    <button className="mx-4 mt-8 mb-2 w-full px-4 py-3 bg-green-700 text-white font-bold rounded-sm">Details</button>
                    </section>
                </CardFooter>
            )}
        />
